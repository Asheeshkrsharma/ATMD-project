...
plot3(ris(1,1),ris(1,2),ris(1,3),'w*','LineWidth',2,'MarkerSize',2)
plot3(ris(end,1),ris(end,2),ris(end,3),'g+','LineWidth',2,'MarkerSize',7)
...
plot3(ri_e_bckp(1),ri_e_bckp(2),ri_e_bckp(3),'g*','MarkerSize',7)
...
plot3(ris(1,1),ris(1,2),ris(1,3),'r*','MarkerSize',7)
plot3(ris(end,1),ris(end,2),ris(end,3),'r+','LineWidth',2,'MarkerSize',7)
